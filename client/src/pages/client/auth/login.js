...
import { setAccessTokenUser, setRefreshTokenUser } from "@/utils/common";
...
function LoginPage() {
	...
	useEffect(() => {
		...
		console.log("loginCheck ==> ", { refreshToken, accessToken, user });
	...
	const handleLogin = async (email, password) => {
		...
		if (res.status == 200) {
			...
			setAccessTokenUser(access_token);
			setRefreshTokenUser(refresh_token);
